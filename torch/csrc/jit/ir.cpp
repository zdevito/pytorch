...
std::ostream& printPyObject_no_python(std::ostream& out, const THPObjectPtr& obj) {
  throw std::runtime_error("Trying to print Python object from a C++ build");
}

std::string pythonOpName_no_python(const PythonOp* t) {
...
std::ostream& (*printPyObjectPtr)(std::ostream&, const THPObjectPtr&) = &printPyObject_no_python;
std::string (*pythonOpNamePtr)(const PythonOp*) = &pythonOpName_no_python;

std::ostream& printPyObject(std::ostream& out, const THPObjectPtr& obj){
    return printPyObjectPtr(out, obj);
}

std::string PythonOp::name() const{
    return pythonOpNamePtr(this);
}
