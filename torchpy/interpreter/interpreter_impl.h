...
struct InterpreterSessionImpl {
 ...
 private:
  ...
  virtual PythonObject call(PythonObject obj, at::ArrayRef<PythonObject> args) = 0;
  virtual PythonObject call(PythonObject obj, at::ArrayRef<at::IValue> args) = 0;
...
// inline definitions for PythonObject are necessary to avoid introducing a source file that would need to exist it both
// the libinterpreter.so and then the libtorchpy library.
